        ...
        <section className="login-shell">
          <div className="login-panel">
            <div className="login-card-header">
              ...
              <div>
                ...
                <p>{isSignup ? "새 계정을 만들고 단어 퀴즈를 시작하세요." : "저장된 학습 흐름으로 바로 돌아갑니다."}</p>
              </div>
            </div>
          ...
          <aside className="login-product-panel">
            ...
            <div className="login-product-copy">
              <h2>{isSignup ? "오늘의 단어 퀴즈를 준비하세요." : "오늘의 단어 학습을 이어가세요."}</h2>
              <p>로그인 후 단어 퀴즈 화면으로 곧바로 전환됩니다.</p>
            </div>
